...
path — `[text][ref]` in the prose, `[ref]: /llmwiki/path/page.md` in a footer
...
3. **It removes the arithmetic from vendoring.** An absolute rewrite is a
   ...
   answer per page.
4. **It reads.** `/llmwiki/deps/@scope/pkg/traits.md` states what it points
...
[index-files]: /llmwiki/format/index-files.md
