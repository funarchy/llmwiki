...
answer-must-mention: ["package.json#files", wiki-sticky.yaml]
---

## Correct answer

Ship the bundle root and `wiki-sticky.yaml` in `package.json#files` — what
`wiki-sticky init` writes into a producer's `package.json` — so the npm
