...
description: Why wiki-sticky hoists dependencies flat and refuses rather than nests conflicting versions
tags: [composition]
sources:
...
each version at a different depth in `node_modules`, wiki-sticky refuses: when
